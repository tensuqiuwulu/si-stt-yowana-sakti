    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card card-primary">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <form action="<?= base_url('anggota/save') ?>" id="form_admin" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="role" name="role" value="Anggota" disabled>
              </div>
              <div class="form-group">
